...
2. **Configure environment variables:**
   ...
   cp .env.example .env
   ```
   Edit `.env` with your preferred editor and fill in your tokens and credentials:
   ```ini
   ...
   APP_USER=android
   APP_PASSWORD=YourAppPasswordHere
...
| `APP_PASSWORD` | **Yes** | None | Kleinanzeigen API mobile password |
